...
extern const u8 gText_MenuOptionGoHome[];
...
extern const u8 gText_ApMessagesFiller[];
extern const u8 gText_ApMessagesUseful[];
extern const u8 gText_ApMessagesProgression[];
extern const u8 gText_TurboButtonA[];
extern const u8 gText_TurboButtonB[];
...
extern const u8 gText_SkipNickname[];
...
extern const u8 gText_DeathLink[];
extern const u8 gText_BlindTrainers[];
extern const u8 gText_AlwaysCatch[];
extern const u8 gText_AlwaysEscape[];
extern const u8 gText_AlwaysReel[];
extern const u8 gText_ApMessages[];
...
extern const u8 gText_Birch_Welcome_Emerald[];
...
extern const u8 gText_Birch_WhatTimeIsIt[];
extern const u8 gText_Birch_ChooseYourPartner[];
