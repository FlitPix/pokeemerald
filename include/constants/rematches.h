...
#define REMATCH_WALLY_VR      64  // Entries above WALLY are considered normal trainers, from Wally below are special trainers
...
#define REMATCH_SIDNEY        73 // Entries from SIDNEY below are considered part of REMATCH_ELITE_FOUR_ENTRIES.
#define REMATCH_PHOEBE        74
#define REMATCH_GLACIA        75
#define REMATCH_DRAKE         76
#define REMATCH_WALLACE       77
#define REMATCH_TABLE_ENTRIES 78 // The total number of rematch entries. Must be last in enum
//};
