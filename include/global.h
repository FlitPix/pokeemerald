...
struct SaveBlock1
{
    ...
    /*0x560*/ struct ItemSlot bagPocket_Items[BAG_ITEMS_COUNT];         // size: 0x168; +0xF0 compared to vanilla
    /*0x740*/ struct ItemSlot bagPocket_KeyItems[BAG_KEYITEMS_COUNT];   // size: 0x0F0; +0x78 compared to vanilla; shift everything after this forwards by 0x168
    ...
    /*0x3324*/ struct ExternalEventData externalEventData;
